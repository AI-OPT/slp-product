...
public class ExProductSearchCriteria {
    ...
    public static class ExProductSearchCriteriaBuilder {
        ...
        public ExProductSearchCriteriaBuilder skuNameLike(String skuName) {
            exProductSearchCriteria.searchfieldVos.add(new SearchfieldVo(SearchFieldConfConstants.SKUNAME,
        ...
        public ExProductSearchCriteriaBuilder skuNameCat(String skuName) {
            exProductSearchCriteria.searchfieldVos.get(0).addSubSearchFieldVo(new SearchfieldVo(SearchFieldConfConstants.SKUNAME,
                    skuName, new SearchOption(SearchOption.SearchLogic.must, SearchOption.SearchType.querystring)));
            return this;
        }
        // 卖点
        public ExProductSearchCriteriaBuilder sellPointLike(String sellPoint) {
            exProductSearchCriteria.searchfieldVos.add(new SearchfieldVo(SearchFieldConfConstants.SELL_POINT,
        ...
        public ExProductSearchCriteriaBuilder rechargeTypeIs(String rechagetype) {
            exProductSearchCriteria.searchfieldVos.add(new SearchfieldVo(SearchFieldConfConstants.RECHAGE_TYPE,
       ...
       //充值方式not in
        ...
        public ExProductSearchCriteriaBuilder basicOrgIdIs(String basicorgid) {
            exProductSearchCriteria.searchfieldVos.add(new SearchfieldVo(SearchFieldConfConstants.BASIC_ORG,
        ...
        public ExProductSearchCriteriaBuilder categoryIdIs(String categoryId){
            exProductSearchCriteria.searchfieldVos.add(new SearchfieldVo(SearchFieldConfConstants.CATEGORY_ID,
       ...
       //子类目
        public ExProductSearchCriteriaBuilder productCategoryIdIs(String productcategoryid){
            exProductSearchCriteria.searchfieldVos.add(new SearchfieldVo(SearchFieldConfConstants.PRODUCT_CATEGORY_ID,
        ...
        public ExProductSearchCriteriaBuilder attrValueLike(String attrValue){
            exProductSearchCriteria.searchfieldVos.add(new SearchfieldVo(SearchFieldConfConstants.ATTR_VALUE,
        ...
        public ExProductSearchCriteriaBuilder attrID(String attrValue){
            exProductSearchCriteria.searchfieldVos.add(new SearchfieldVo(SearchFieldConfConstants.ATTR_ID,
        ...
        public ExProductSearchCriteriaBuilder attrValueDefID(String attrValueDefId){
            exProductSearchCriteria.searchfieldVos.add(new SearchfieldVo(SearchFieldConfConstants.ATTRVALUE_DEF_ID,
        ...
        public ExProductSearchCriteriaBuilder tenantID(String tenantId){
            exProductSearchCriteria.searchfieldVos.add(new SearchfieldVo(SearchFieldConfConstants.TENANT_ID,
                    tenantId, new SearchOption(SearchOption.SearchLogic.must, SearchOption.SearchType.term)));
            return this;
        }
        // 排序
        public ExProductSearchCriteriaBuilder addOrderBy(String orderByField, SortType sortType) {
            exProductSearchCriteria.sortFields.add(new SortField(orderByField, sortType.getValue()));
            return this;
        }
