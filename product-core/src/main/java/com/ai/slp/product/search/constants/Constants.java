...
public class Constants {
    ...
    public static class QUERY_SQL {
        ...
        public static final String FETCH_ATTR_INFO_SQL = "SELECT standed_prod_attr.ATTR_ID as attrID, standed_prod_attr.ATTR_VALUE_NAME as attrValue,standed_prod_attr.ATTRVALUE_DEF_ID as attrValueDefId from product inner join standed_prod_attr on product.STANDED_PROD_ID = standed_prod_attr.STANDED_PROD_ID where product.PROD_ID = ?";
